...
setenv("crtm_ROOT","/scratch1/NCEPDEV/da/Andrew.Collard/git/CRTMv3_dev/build")
setenv("crtm_VERSION","3.1.1")
setenv("CRTM_INC","/scratch1/NCEPDEV/da/Andrew.Collard/git/CRTMv3_dev/build/module/crtm/Intel/2021.5.0.20211109")
setenv("CRTM_LIB","/scratch1/NCEPDEV/da/Andrew.Collard/git/CRTMv3_dev/build/libcrtm.a")
setenv("CRTM_FIX","/scratch1/NCEPDEV/da/Andrew.Collard/git/CRTMv3_dev/fix")
whatis("Name: crtm")
